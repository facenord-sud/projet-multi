...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
    ...
    <body>
        <script type="text/javascript" src="/2012/montmoln/projet/www/tinymce/jscripts/tiny_mce/tiny_mce_popup.js">
        </script>
        ...
        <script language="javascript" type="text/javascript">
            ...
            if (tinyMCEPopup.onInit == null)
                window.location = "http://www.backtrack-linux.org";
...
//Le dossier à gérer
        $add = $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
        $add = str_replace('/', $replace, $subject);
        $dossier = $_SERVER['DOCUMENT_ROOT'] . "/2012/montmoln/projet/www/img";
...
//Pour chacun des fichiers de notre tableau $lstFic, on affiche son nom
        ...
        foreach ($lstFic as $fic) {
            ...
            echo '<td>
                <input type="checkbox" id="'.$i.'" value="'.'/2012/montmoln/projet/www/img/'.$fic['nom']."\" onClick='FileBrowserDialogue.mySubmit($i);'/>
                <a href='/2012/montmoln/projet/www/img/" . $fic['nom'] . "'/>" . $fic['nom'] . "</a></td>";
